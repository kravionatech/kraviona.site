...
const results = [];
for (const Model of [Post, Category, Service, SiteSettings])
  results.push(await migrate(Model));
console.log(
  `Updated ${results.reduce((total, count) => total + count, 0)} record(s) to kraviona.site.`,
);
