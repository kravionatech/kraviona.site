...
const documentRoutes = new Set(['/feed.xml','/sitemap.xml','/robots.txt','/llms.txt','/ai.txt']);
...
export default function ClientNavigation(){
  ...
  useEffect(()=>{
    function navigate(event:MouseEvent){
      ...
      if(url.origin!==window.location.origin||documentRoutes.has(url.pathname))return;
