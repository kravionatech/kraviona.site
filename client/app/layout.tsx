...
export default async function RootLayout({children}:{children:React.ReactNode}){
  ...
  const official=absoluteUrl(settings.officialSiteUrl||OFFICIAL_MAIN_SITE_URL).replace(/\/$/, '');
  ...
  return <html lang="en-IN"><body>
    ...
    <footer className="site-footer">
      <div className="wrap footer-top">
        <div className="footer-pitch"><a className="brand brand--light" href="/">{brand.toLowerCase()}<span>.</span></a><p>{description}</p><a className="official-badge" href={official} target="_blank" rel="noopener noreferrer"><b>Official company website</b><span>kraviona.com ↗</span></a></div>
