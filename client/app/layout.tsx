import './globals.css';import './compat.css';import type {Metadata,Viewport} from 'next';import Script from 'next/script';import {api} from '../lib/api';import {absoluteUrl,DEFAULT_OG_IMAGE,jsonLd,SITE_DESCRIPTION,SITE_NAME,SITE_URL} from '../lib/site';import ClientNavigation from '../components/ClientNavigation';
