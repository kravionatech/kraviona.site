...
const units = {
  ...
  "300x250": {
    key: "5e779c24fe6f6e12e48dfef48c8ffd6b",
    width: 300,
    height: 250,
  },
  "160x300": {
    key: "c13505ff9221c6a5136edca665dd34b5",
    width: 160,
    height: 300,
  },
  "160x600": {
    key: "94821387308662eedb4a42c5a1a183ef",
    width: 160,
    height: 600,
  },
...
export async function GET(
  ...
  return new Response(
    `<!doctype html><html><head><meta name="robots" content="noindex,nofollow"><style>html,body{margin:0;padding:0;overflow:hidden;background:transparent}body{display:flex;justify-content:center;align-items:flex-start}</style></head><body>${body}</body></html>`,
    {
      headers: {
