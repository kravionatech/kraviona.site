...
export default async function Home() {
  ...
  return <>
    ...
    <div className="wrap">
      <DirectLinkAd title="Explore Kraviona Official Portal" description="Discover products, core technology platforms and official services on our main domain." buttonText="Visit kraviona.com ↗" targetUrl={official} />
    </div>
